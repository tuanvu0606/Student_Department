...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { closure_date: @faculty.closure_date, final_closure_date: @faculty.final_closure_date, name: @faculty.name } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { closure_date: @faculty.closure_date, final_closure_date: @faculty.final_closure_date, name: @faculty.name } }
